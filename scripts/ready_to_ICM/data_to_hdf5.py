...
outname = "angles_data_w_labels.h5"
...
with h5py.File(outname, 'w') as hf:
    ...
    angles = hf.create_dataset('shift',shape=(len(inname_list)*num_dat_files*Nevt,4),dtype=np.float32)
        ...
        with tarfile.open(inname, "r:gz") as tar:
            ...
            for filename in dat_files:
                ...
                for j in range(start_index,end_index):
                    ...
                    angles[shuffled_indices[j]] = shift
