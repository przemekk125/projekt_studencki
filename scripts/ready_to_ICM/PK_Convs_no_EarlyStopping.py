...
# EXAMPLE MODEL
models.append(GetModel(convFilters=[16,32,64],denseNeurons=[64,32,16],LossFunction=snorm_MSE))
names.append("conv_adcending")
models.append(GetModel(convFilters=[64,32,16],denseNeurons=[64,32,16],LossFunction=snorm_MSE))
